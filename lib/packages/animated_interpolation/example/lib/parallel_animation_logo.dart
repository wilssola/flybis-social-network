...
class AnimatedLogo1 extends AnimatedWidget {
  ...
  static final _sizeTween = new InterpolationTween(
      inputRange: [0, 0.2, 1], outputRange: [0, 250, 300]);
  static final _colorTween = ColorInterpolationTween(
      inputRange: [0, 0.2, 1],
      outputRange: [Colors.white, Colors.green, Colors.red]);
  ...
  Widget build(BuildContext context) {
    ...
    return new Center(
      child: new Opacity(
        opacity: createInterpolation(InterpolationConfigType(
            inputRange: [0, 1], outputRange: [0.1, 1]))(animation.value),
        child: new Container(
