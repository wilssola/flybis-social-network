...
import 'package:flybis/services/admob_service.dart' as admob_service;
import 'package:flybis/services/follow_service.dart';
import 'package:flybis/services/friend_service.dart';
import 'package:flybis/services/post_service.dart';
import 'package:flybis/services/user_service.dart';
import 'package:flybis/views/profile_edit_view.dart' as profile_edit_view;
import 'package:flybis/widgets/post_widget.dart' as post_widget;
...
class _ProfileViewState extends State<ProfileView> {
  ...
  Widget profile() {
    final Widget ad = admob_service.AdmobService().showAdmob(
      padding: EdgeInsets.only(top: 10),
      ...
      children: <Widget>[
        ...
        !kIsWeb
            ...
            : utils_widget.UtilsWidget().webBody(
                context,
                child: kNotIsWebOrScreenLittle(context) ? ad : Card(child: ad),
              ),
        !kIsWeb
            ? streamPosts()
            : utils_widget.UtilsWidget().webBody(
