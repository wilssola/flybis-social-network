...
class _PostWidgetState extends State<PostWidget> {
  ...
  buildPostHeader() {
    ...
    return FutureBuilder(
      future: usersRef.document(widget.post.ownerId).get(source: Source.serverAndCache),
      builder: (context, snapshot) {
        ...
        return Container(
          ...
          child: ListTile(
            ...
            trailing: IconButton(
              onPressed: () => handleDeletePost(context, isPostOwner),
              icon: Icon(FeatherIcons.moreVertical, color: Colors.black),
            ),
          ),
        );
      },
    ...
    return Column(
      children: <Widget>[
        ...
        Row(
          ...
          children: <Widget>[
            Container(
              margin: widget.post.description.length > 0
                  ? EdgeInsets.only(right: 25, left: 25, top: 10, bottom: 25)
                  : EdgeInsets.all(5),
              child: Row(
                children: <Widget>[
                  Text(
