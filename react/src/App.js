...
const strings = new LocalizedStrings({
  en: {
    ...
    description: 'A place where your opinion directly influences the relevance and dissemination of all content created by the community.',
  ...
  pt: {
    ...
    description: 'Um lugar onde a sua opinião influencia diretamente na relevância e divulgação de todos os conteúdos criados pela comunidade.',
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <ul>
          <li>
            <a className="App-link App-header-item" href="/download" rel="noopener noreferrer">
              {strings.download}
            </a>
          </li>
          <li>
            <a className="App-link App-header-item" href="/privacy" rel="noopener noreferrer">
              {strings.privacy}
            </a>
          </li>
          <li>
            <a className="App-link App-header-item" href="mailto:flybis@tecwolf.com.br" rel="noopener noreferrer">
              {strings.support}
            </a>
          </li>
          <li>
            <a className="App-link App-header-item" href="/about" rel="noopener noreferrer">
              {strings.about}
            </a>
          </li>
        </ul>
